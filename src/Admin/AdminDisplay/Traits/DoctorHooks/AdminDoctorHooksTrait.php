    ...
    trait AdminDoctorHooksTrait {
        ...
        private function mss_doctor_admin_assets( $hook ): void {
            ...
            wp_localize_script(
                    ...
                    [
                        "wp_nonce" => wp_create_nonce( "mss_admin_doc_nonce" ),
                    ]
            );
        }
        /**
         * Ajax hook
         * **/
       private function mss_doctor_ajax( AdminDoctorAjaxController $admin_doc_ajax ){
           add_action("wp_ajax_admin_doctor_profile_upload", [ $admin_doc_ajax ,  "doctor_profile_upload" ]);
       }
    }
